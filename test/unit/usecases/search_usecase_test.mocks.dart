...
// in sociaanet/test/unit/usecases/search_usecase_test.dart.
...
class MockSearchDatasource extends _i1.Mock implements _i2.SearchDatasource {
  @override
  _i3.Future<List<dynamic>> searchUsers(String? query) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<List<dynamic>> searchPosts(String? query) =>
      (super.noSuchMethod(
